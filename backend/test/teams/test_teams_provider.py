...
class TestTeamsProvider(TestCase):
    def test_all(self) -> None:
        ...
        fixtures = [
            Fixture(team_one, team_two, "japan 2", 0.0, 0.0, 0.0, 0.0),
            Fixture(team_one, team_three, "japan 1", 0.0, 0.0, 0.0, 0.0),
            Fixture(team_two, team_three, "japan 1", 0.0, 0.0, 0.0, 0.0)
        ]
