...
class TestModelsApi(TestCase):
    ...
    def test_list_models(self) -> None:
        ...
        self.assertEqual({'models': [
            ...
            {"name": "Improved Linear regression", "predicts_in_progress": False},
            {"name": "AdaBoost Classifier", "predicts_in_progress": False},
            {"name": "Gaussian Naive Bayes", "predicts_in_progress": False},
        ]}, response.get_json())
