...
from matchpredictor.predictors.gaussian_nb_predictor import train_nb_predictor
from matchpredictor.predictors.home_predictor import HomePredictor
from matchpredictor.predictors.improved_LR_predictor import train_improved_regression_predictor
...
def build_model_provider(training_data: List[Result]) -> ModelProvider:
    return ModelProvider([
        ...
        Model("Alphabetic", AlphabeticPredictor()),
        ...
        Model("Improved Linear regression", train_improved_regression_predictor(training_data)),
        Model("AdaBoost Classifier", train_adaboost_predictor(training_data)),
        Model("Gaussian Naive Bayes", train_nb_predictor(training_data))
    ])
